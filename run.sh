...
sudo docker run -v /mnt/ztool/profiles:/home/ztooluser/profiles:Z --shm-size=16g -p 80:8686 --rm --name ztool --dns="1.1.1.1" --dns="1.0.0.1" --cap-add=SYS_ADMIN nft9/ztool:stable

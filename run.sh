...
sysctl -p
sudo docker run -p 80:8686 --rm --name ztool -v $PWD/data:/home/ztooluser/data:Z --shm-size=16g --cpus="0.8" --dns="1.1.1.1" --dns="1.0.0.1" --cap-add=SYS_ADMIN nft9/ztool:stable &
